...
from sift_parse_core.types.doc.utils import relative_path
    ...
    try:
        ...
        if "user-agent" not in req_headers:
            try:
                ...
                agent_name = f"sift-parse-core/{importlib.metadata.version('sift-parse-core')}"
            except Exception:
                agent_name = "sift-parse-core"
