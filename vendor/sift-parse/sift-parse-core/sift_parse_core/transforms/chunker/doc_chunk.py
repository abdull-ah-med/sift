...
from sift_parse_core.transforms.chunker import BaseChunk, BaseMeta
from sift_parse_core.types.base import VERSION_PATTERN
from sift_parse_core.types.doc.document import DocItem, DocumentOrigin
...
class DocMeta(BaseMeta):
    ...
    schema_name: Literal["sift_parse_core.transforms.chunker.DocMeta"] = Field(
        default="sift_parse_core.transforms.chunker.DocMeta",
