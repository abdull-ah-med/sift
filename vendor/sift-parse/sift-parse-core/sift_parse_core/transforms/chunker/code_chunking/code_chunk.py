...
from sift_parse_core.transforms.chunker.base import BaseChunk
from sift_parse_core.transforms.chunker.doc_chunk import _KEY_SCHEMA_NAME, DocMeta
...
class CodeDocMeta(DocMeta):
    ...
    schema_name: Literal["sift_parse_core.transforms.chunker.CodeDocMeta"] = Field(  # type: ignore[assignment]
        default="sift_parse_core.transforms.chunker.CodeDocMeta",
