...
from sift_parse_core.transforms.chunker import (
    BaseChunk,
    BaseChunker,
    DocChunk,
    DocMeta,
...
from sift_parse_core.transforms.chunker.line_chunker import LineBasedTokenChunker
from sift_parse_core.transforms.chunker.tokenizer.base import BaseTokenizer
from sift_parse_core.transforms.serializer.base import (
    BaseDocSerializer,
    BaseSerializerProvider,
)
from sift_parse_core.types.doc import DoclingDocument, SectionHeaderItem, TableItem, TitleItem
...
_SEMCHUNK_INSTALL_HINT = (
    ...
    "Install it with `pip install 'sift-parse-core[chunking]'` or "
    "`pip install 'sift-parse-core[chunking-openai]'`."
)
...
def _get_default_tokenizer():
    ...
    """
    from sift_parse_core.transforms.chunker.tokenizer.huggingface import get_default_tokenizer
        ...
        if isinstance(data, dict):
            ...
            if not isinstance(tokenizer, BaseTokenizer) and (
                ...
                warnings.warn(
                    ...
                    "https://docling-project.github.io/sift_parse/examples/hybrid_chunking/",
                    DeprecationWarning,
                )
