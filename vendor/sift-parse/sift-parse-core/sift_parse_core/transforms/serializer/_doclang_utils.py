...
from sift_parse_core.types.doc.document import FieldItem, FieldRegionItem
from sift_parse_core.types.doc.labels import CodeLanguageLabel, PictureClassificationLabel
...
_DOCLANG_META_NAMESPACE: Final = "sift_parse"
