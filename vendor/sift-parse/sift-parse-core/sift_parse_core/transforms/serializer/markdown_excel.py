...
from sift_parse_core.transforms.serializer.common import create_ser_result
from sift_parse_core.transforms.serializer.markdown import (
    MarkdownDocSerializer,
    MarkdownFallbackSerializer,
)
from sift_parse_core.types.doc.document import DoclingDocument, GroupItem, NodeItem
from sift_parse_core.types.doc.labels import GroupLabel
...
class MsExcelMarkdownDocSerializer(MarkdownDocSerializer):
    ...
    Usage::
        ...
        from sift_parse_core.transforms.serializer.markdown_excel import (
