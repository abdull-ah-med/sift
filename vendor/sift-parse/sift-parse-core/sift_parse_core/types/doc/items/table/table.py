...
from sift_parse_core.types.doc.common.meta import DescriptionMetaField, FloatingMeta, MetaUtils
from sift_parse_core.types.doc.items.node import FloatingItem
from sift_parse_core.types.doc.items.table.table_data import TableCell, TableData
...
class TableItem(FloatingItem):
    ...
    def export_to_html(
        ...
        if doc is not None:
            from sift_parse_core.transforms.serializer.html import HTMLDocSerializer
    ...
    def export_to_otsl(
        ...
        **kwargs: Any,
        ...
        from sift_parse_core.transforms.serializer.doctags import DocTagsDocSerializer
