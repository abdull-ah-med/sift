...
from sift_parse_core.types.doc.base import BoundingBox, CoordOrigin
from sift_parse_core.types.doc.common.reference import RefItem
...
class TableCell(BaseModel):
    ...
    def from_dict_format(cls, data: Any) -> Any:
        ...
        if isinstance(data, dict):
            # Check if this is a native BoundingBox or a bbox from sift-parse-models
            if (
                # "bbox" not in data
...
class RichTableCell(TableCell):
    ...
    @override
    def _get_text(self, doc: Optional["DoclingDocument"] = None, **kwargs: Any) -> str:
        from sift_parse_core.transforms.serializer.markdown import MarkdownDocSerializer
