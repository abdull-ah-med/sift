...
from sift_parse_core.types.doc.base import ImageRefMode
from sift_parse_core.types.doc.common.annotations import BaseAnnotation, DescriptionAnnotation, MiscAnnotation
from sift_parse_core.types.doc.common.meta import (
    DescriptionMetaField,
    MetaUtils,
)
from sift_parse_core.types.doc.items.node import FloatingItem
...
from sift_parse_core.types.doc.items.picture.classification import PictureClassificationData
