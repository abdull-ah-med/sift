...
from sift_parse_core.types.doc.common.scalars import Uint64
...
class DocumentOrigin(BaseModel):
    ...
    _extra_mimetypes: typing.ClassVar[list[str]] = [
        ...
        "application/vnd.sift_parse.ebcdic",  # accepted alias, see application/x-ebcdic
        ...
        # spelling sift_parse emits; the vendor-tree alias above is accepted as well.
