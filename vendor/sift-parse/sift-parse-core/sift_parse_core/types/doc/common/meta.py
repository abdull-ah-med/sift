...
from sift_parse_core.types.base import UniqueList
from sift_parse_core.types.doc.base import PydanticSerCtxKey, round_pydantic_float
from sift_parse_core.types.doc.common.scalars import CharSpan
from sift_parse_core.types.doc.labels import CodeLanguageLabel, HumanLanguageLabel
from sift_parse_core.utils.validators import ensure_unique_list
...
class MetaUtils:
    ...
    _META_FIELD_LEGACY_NAMESPACE: Final = "sift_parse_legacy"
