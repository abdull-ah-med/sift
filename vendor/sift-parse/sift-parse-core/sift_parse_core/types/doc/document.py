...
from sift_parse_core.types.base import _JSON_POINTER_REGEX, VERSION_PATTERN, UniqueList
from sift_parse_core.types.doc import BoundingBox, Size
from sift_parse_core.types.doc.base import (
    CoordOrigin,
    ImageRefMode,
    PydanticSerCtxKey,
...
from sift_parse_core.types.doc.common.annotations import (
    BaseAnnotation,
    DescriptionAnnotation,
    MiscAnnotation,
)
from sift_parse_core.types.doc.common.constants import (
    CURRENT_VERSION,
    DEFAULT_EXPORT_LABELS,
    DOCUMENT_TOKENS_EXPORT_LABELS,
)
from sift_parse_core.types.doc.common.content_layer import DEFAULT_CONTENT_LAYERS, ContentLayer
from sift_parse_core.types.doc.common.formatting import Formatting, Script
from sift_parse_core.types.doc.common.meta import (
    BaseMeta,
    BasePrediction,
    CodeMetaField,
...
from sift_parse_core.types.doc.common.origin import DocumentOrigin
from sift_parse_core.types.doc.common.reference import (
    CV2_INSTALLED,
    FineRef,
    ImageRef,
    PageItem,
...
from sift_parse_core.types.doc.common.scalars import CharSpan, LevelNumber, Uint64
from sift_parse_core.types.doc.common.source import BaseSource, SourceType, TrackSource
from sift_parse_core.types.doc.doctags import DocTagsDocument, DocTagsPage
from sift_parse_core.types.doc.items.code import CodeItem
from sift_parse_core.types.doc.items.content import ContentItem
from sift_parse_core.types.doc.items.form import FieldHeadingItem, FieldItem, FieldRegionItem, FieldValueItem
from sift_parse_core.types.doc.items.group import GroupItem, InlineGroup, ListGroup, OrderedList, UnorderedList
from sift_parse_core.types.doc.items.key_value import FormItem, GraphCell, GraphData, GraphLink, KeyValueItem
from sift_parse_core.types.doc.items.node import DocItem, FloatingItem, NodeItem
from sift_parse_core.types.doc.items.picture.charts import (
    ChartBar,
    ChartLine,
    ChartPoint,
    ChartSlice,
...
from sift_parse_core.types.doc.items.picture.classification import PictureClassificationClass, PictureClassificationData
from sift_parse_core.types.doc.items.picture.meta import (
    MoleculeMetaField,
...
from sift_parse_core.types.doc.items.picture.molecule import PictureMoleculeData
from sift_parse_core.types.doc.items.picture.picture import (
    BasePictureData,
    PictureDataType,
...
from sift_parse_core.types.doc.items.table.table import TableAnnotationType, TableItem
from sift_parse_core.types.doc.items.table.table_data import (
    AnyTableCell,
    Orientation,
    RichTableCell,
    TableCell,
...
from sift_parse_core.types.doc.labels import (
    CodeLanguageLabel,
    DocItemLabel,
    GraphCellLabel,
    GraphLinkLabel,
...
from sift_parse_core.types.doc.tokens import DocumentToken, TableToken
from sift_parse_core.types.doc.utils import (
...
from sift_parse_core.utils.settings import settings
...
class DoclingDocument(BaseModel):
    ...
    def export_to_markdown(
        ...
        *,
        ...
        """
        from sift_parse_core.transforms.serializer.markdown import (
    ...
    def export_to_text(
        ...
        :rtype: str
        """
        from sift_parse_core.transforms.serializer.plain_text import (
    ...
    def export_to_vtt(
        ...
        """
        from sift_parse_core.transforms.serializer.webvtt import WebVTTDocSerializer, WebVTTParams
    ...
    def export_to_doctags(
        ...
        :rtype: str
        """
        from sift_parse_core.transforms.serializer.doctags import (
    ...
    def export_to_doclang(
        ...
        """Export to DocLang."""
        from sift_parse_core.transforms.serializer.doclang import DocLangDocSerializer, DocLangParams
    ...
    def get_visualization(
        ...
        """
        from sift_parse_core.transforms.visualizer.base import BaseVisualizer
        from sift_parse_core.transforms.visualizer.key_value_visualizer import (
            KeyValueVisualizer,
        )
        from sift_parse_core.transforms.visualizer.layout_visualizer import (
            LayoutVisualizer,
        )
        from sift_parse_core.transforms.visualizer.reading_order_visualizer import (
