...
from sift_parse_core.types.doc.tokens import _LOC_PREFIX, DocumentToken, TableToken

if TYPE_CHECKING:
    from sift_parse_core.types.doc.document import TableCell, TableData
...
def otsl_parse_texts(texts: list[str], tokens: list[str]) -> tuple[list["TableCell"], list[list[str]]]:
    ...
    from sift_parse_core.types.doc.document import TableCell
...
def parse_otsl_table_content(otsl_content: str) -> "TableData":
    ...
    from sift_parse_core.types.doc.document import TableData
