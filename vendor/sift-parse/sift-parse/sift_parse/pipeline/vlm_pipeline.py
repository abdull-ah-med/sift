...
from sift_parse.datamodel.document import ConversionResult, InputDocument
...
from sift_parse.models.stages.vlm_convert.vlm_convert_model import VlmConvertModel
...
from sift_parse.pipeline.base_pipeline import PaginatedPipeline
from sift_parse.utils.deepseekocr_utils import parse_deepseekocr_markdown
...
class VlmPipeline(PaginatedPipeline):
    ...
    def _parse_unlimited_ocr_markdown(
        ...
        """
        from sift_parse.utils.deepseekocr_utils import parse_unlimited_ocr_markdown
    ...
    def _parse_chandra_html(self, conv_res: ConversionResult) -> DoclingDocument:
        ...
        from sift_parse.utils.chandra_utils import parse_chandra_html
    ...
    def _parse_dots_json(self, conv_res: ConversionResult) -> DoclingDocument:
        ...
        from sift_parse.utils.dots_utils import parse_dots_json
        from sift_parse.utils.vlm_utils import compute_qwen2vl_image_size
