...
import numpy as np
from sift_parse_core.types.doc import DocItem, ImageRef, PictureItem, TableItem
...
from sift_parse.datamodel.base_models import AssembledUnit, Page
...
from sift_parse.models.base_ocr_model import BaseOcrModel
from sift_parse.models.factories import (
    get_layout_factory,
    get_ocr_factory,
    get_table_structure_factory,
)
from sift_parse.models.stages.code_formula.code_formula_model import (
    CodeFormulaModel,
    CodeFormulaModelOptions,
)
from sift_parse.models.stages.heading_hierarchy.heading_hierarchy_model import (
    HeadingHierarchyModel,
)
from sift_parse.models.stages.layout.layout_postprocessing_model import (
    LayoutPostprocessingModel,
)
from sift_parse.models.stages.page_assemble.page_assemble_model import (
    PageAssembleModel,
    PageAssembleOptions,
)
from sift_parse.models.stages.page_preprocessing.page_preprocessing_model import (
    PagePreprocessingModel,
    PagePreprocessingOptions,
)
from sift_parse.models.stages.reading_order.readingorder_model import (
    ReadingOrderModel,
    ReadingOrderOptions,
)
from sift_parse.pipeline.base_pipeline import PaginatedPipeline
from sift_parse.utils.model_downloader import download_models
...
class LegacyStandardPdfPipeline(PaginatedPipeline):
    ...
    def download_models_hf(
        ...
        warnings.warn(
            ...
            "use instead the utility `sift-parse-tools models download`, or "
            "the upstream method sift_parse.utils.models_downloader.download_all()",
            DeprecationWarning,
            stacklevel=3,
        )
