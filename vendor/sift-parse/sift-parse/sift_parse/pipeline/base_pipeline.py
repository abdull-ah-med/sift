...
from sift_parse_core.types.doc import NodeItem
...
from sift_parse.models.base_model import GenericEnrichmentModel
from sift_parse.models.factories import get_picture_description_factory
from sift_parse.models.picture_description_base_model import PictureDescriptionBaseModel
from sift_parse.models.stages.picture_classifier.document_picture_classifier import (
...
class ConvertPipeline(BasePipeline):
    def __init__(self, pipeline_options: ConvertPipelineOptions):
        ...
        # sift-parse / ONNX-only installs can import DocumentConverter without
        # pulling torch+transformers.
        if pipeline_options.do_chart_extraction:
            from sift_parse.models.stages.chart_extraction.granite_vision import (
