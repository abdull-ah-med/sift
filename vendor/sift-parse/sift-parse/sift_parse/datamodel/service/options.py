...
from sift_parse_core.types.doc import ImageRefMode, PictureClassificationLabel
...
from sift_parse.datamodel import vlm_model_specs
from sift_parse.datamodel.base_models import InputFormat, OutputFormat

# Import new engine system (available in sift_parse>=2.73.0)
...
from sift_parse.datamodel.service.chunking import ChunkingOptionType
...
class VlmModelLocal(BaseModel):
    ...
    prompt: Annotated[
        ...
        Field(
            description="Prompt used when calling the vision-language model.",
            examples=[
                "Convert this page to sift_parse.",
