...
from sift_parse_core.utils.file import (
...
from sift_parse.datamodel.settings import DocumentLimits
from sift_parse.exceptions import DocumentLoadError
from sift_parse.utils.pdf_outline import _PdfOutlineItem
from sift_parse.utils.profiling import ProfilingItem
from sift_parse.utils.utils import create_file_hash, safe_version

if TYPE_CHECKING:
    from sift_parse.datamodel.base_models import BaseFormatOption
...
class DoclingVersion(BaseModel):
    docling_version: str = safe_version("sift_parse")
    docling_slim_version: str = safe_version("sift-parse")
    docling_core_version: str = safe_version("sift-parse-core")
    docling_ibm_models_version: str = safe_version("sift-parse-models")
    docling_parse_version: str = safe_version("sift-parse-pdf")
...
class _DocumentConversionInput(BaseModel):
    ...
    def _filename_from_source(source: str) -> str:
        ...
        Reuses sift-parse-core's ``resolve_remote_filename`` for URLs (the same
