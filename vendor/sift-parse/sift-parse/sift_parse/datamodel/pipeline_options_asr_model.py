"""Configuration models for sift_parse's automatic speech recognition (ASR) backends.
...
auto-selection live in ``sift_parse.datamodel.asr_model_specs``. The auto-selecting
