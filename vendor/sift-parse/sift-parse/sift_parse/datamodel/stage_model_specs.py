...
from sift_parse.datamodel.vlm_prompts import (
...
from sift_parse.models.inference_engines.vlm.base import VlmEngineType
...
VLM_CONVERT_SMOLDOCLING = StageModelPreset(
    ...
    model_spec=VlmModelSpec(
        ...
        prompt="Convert this page to sift_parse.",
