...
from sift_parse_core.types.doc import PictureClassificationLabel
...
from sift_parse.datamodel import (
    asr_model_specs,
    stage_model_specs,
    vlm_model_specs,
)
...
from sift_parse.datamodel.chart_extraction_options import (
    ChartExtractionModelKind,
    ChartExtractionModelOptions,
)
from sift_parse.datamodel.extraction_options import ExtractionPromptStyle
from sift_parse.datamodel.kserve_v2_options import KserveV2OptionsMixin
from sift_parse.datamodel.layout_model_specs import (
...
from sift_parse.datamodel.object_detection_engine_options import (
    BaseObjectDetectionEngineOptions,
)
from sift_parse.datamodel.picture_classification_options import (
    DocumentPictureClassifierOptions,
)
from sift_parse.datamodel.pipeline_options_asr_model import InlineAsrOptions
from sift_parse.datamodel.pipeline_options_vlm_model import (
    ApiVlmOptions,
    InferenceFramework,
    InlineVlmOptions,
    ResponseFormat,
)
from sift_parse.datamodel.stage_model_specs import (
    ObjectDetectionModelSpec,
    ObjectDetectionStagePresetMixin,
    StagePresetMixin,
    VlmModelSpec,
)
from sift_parse.datamodel.vlm_engine_options import BaseVlmEngineOptions
from sift_parse.datamodel.vlm_model_specs import (
...
from sift_parse.models.inference_engines.object_detection.base import (
    ObjectDetectionEngineOptionsMixin,
)
from sift_parse.models.inference_engines.vlm.base import VlmEngineOptionsMixin
    ...
    lang: Annotated[
        ...
        Field(
            description=(
                ...
                "'japan'; the sift_parse defaults 'chinese'/'english' map to 'ch'/'en'). Script-family "
...
class PictureDescriptionBaseOptions(BaseOptions):
    ...
    # may be removed entirely once sift-parse-core drops the deprecated
...
class PictureDescriptionVlmEngineOptions(
    ...
    Examples:
        ...
        from sift_parse.datamodel.vlm_engine_options import MlxVlmEngineOptions, VlmEngineType
...
class VlmConvertOptions(StagePresetMixin, VlmEngineOptionsMixin, BaseModel):
    ...
    Examples:
        ...
        # Use preset with runtime override
        from sift_parse.datamodel.vlm_engine_options import ApiVlmEngineOptions, VlmEngineType
...
def normalize_pdf_backend(backend: PdfBackend) -> PdfBackend:
    ...
    if backend in deprecated_mapping:
        warnings.warn(
            f"PdfBackend.{backend.name} was previously deprecated and removed in this sift_parse version. Using PdfBackend.DOCLING_PARSE instead. ",
            DeprecationWarning,
            stacklevel=3,
        )
    ...
    artifacts_path: Annotated[
        ...
        Field(
            description=(
                ...
                "fetched from remote sources on first use. Use `sift-parse-tools models download` to pre-fetch artifacts "
...
from sift_parse.utils.video_frame_sampling import VideoFrameSamplingMode  # noqa: E402
