...
from sift_parse_core.types.doc.document import DocTagsDocument
from PIL import Image as PILImage

if TYPE_CHECKING:
    from sift_parse_core.types.doc.page import SegmentedPage

from sift_parse.backend.abstract_backend import AbstractDocumentBackend
from sift_parse.backend.sift_parse_pdf_backend import ThreadedDoclingParseDocumentBackend
from sift_parse.backend.pdf_backend import PdfDocumentBackend
from sift_parse.datamodel.base_models import ConversionStatus, Page
from sift_parse.datamodel.document import ConversionResult
...
from sift_parse.experimental.datamodel.threaded_layout_vlm_pipeline_options import (
    ThreadedLayoutVlmPipelineOptions,
)
from sift_parse.models.base_model import BaseVlmPageModel
from sift_parse.models.factories import get_layout_factory
from sift_parse.models.stages.layout.layout_postprocessing_model import (
    LayoutPostprocessingModel,
)
from sift_parse.models.vlm_pipeline_models.api_vlm_model import ApiVlmModel
from sift_parse.models.vlm_pipeline_models.hf_transformers_model import (
    HuggingFaceTransformersVlmModel,
)
from sift_parse.models.vlm_pipeline_models.mlx_model import HuggingFaceMlxModel
from sift_parse.pipeline.base_pipeline import BasePipeline
from sift_parse.pipeline.standard_pdf_pipeline import (
    ProcessingResult,
    RunContext,
    ThreadedItem,
...
from sift_parse.utils.profiling import ProfilingScope, TimeRecorder
...
class ThreadedLayoutVlmPipeline(BasePipeline):
    ...
    def _init_models(self) -> None:
            ...
            def build_prompt(
                ...
                *,
                ...
                if _internal_page.predictions.layout:
                    from sift_parse_core.types.doc.tokens import DocumentToken
        ...
        if isinstance(base_vlm_options, ApiVlmOptions):
            ...
            if vlm_options.inference_framework == InferenceFramework.TRANSFORMERS:
                ...
                from sift_parse.models.vlm_pipeline_models.vllm_model import VllmVlmModel
    ...
    def _assemble_document(self, conv_res: ConversionResult) -> ConversionResult:
        ...
        from sift_parse_core.types.doc import DocItem, ImageRef, PictureItem

        from sift_parse.datamodel.pipeline_options_vlm_model import ResponseFormat
