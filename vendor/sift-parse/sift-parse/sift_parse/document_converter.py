...
from sift_parse.backend.abstract_backend import (
    AbstractDocumentBackend,
)
from sift_parse.backend.asciidoc_backend import AsciiDocBackend
from sift_parse.backend.boxnote_backend import BoxNoteDocumentBackend
from sift_parse.backend.csv_backend import CsvDocumentBackend
from sift_parse.backend.sift_parse_pdf_backend import DoclingParseDocumentBackend
from sift_parse.backend.ebcdic_backend import EbcdicDocumentBackend
from sift_parse.backend.email_backend import EmailDocumentBackend
from sift_parse.backend.epub_backend import EpubDocumentBackend
from sift_parse.backend.html_backend import HTMLDocumentBackend
from sift_parse.backend.image_backend import ImageDocumentBackend
from sift_parse.backend.json.sift_parse_json_backend import DoclingJSONBackend
from sift_parse.backend.latex_backend import LatexDocumentBackend
from sift_parse.backend.md_backend import MarkdownDocumentBackend
from sift_parse.backend.mets_gbs_backend import MetsGbsDocumentBackend
from sift_parse.backend.msexcel_backend import MsExcelDocumentBackend
from sift_parse.backend.mspowerpoint_backend import MsPowerpointDocumentBackend
from sift_parse.backend.msword_backend import MsWordDocumentBackend
from sift_parse.backend.noop_backend import NoOpBackend
from sift_parse.backend.opendocument_backend import (
    OdpDocumentBackend,
    OdsDocumentBackend,
    OdtDocumentBackend,
)
from sift_parse.backend.webvtt_backend import WebVTTDocumentBackend
from sift_parse.backend.xml.doclang_archive_backend import DocLangArchiveBackend
from sift_parse.backend.xml.doclang_backend import DocLangDocumentBackend
from sift_parse.backend.xml.jats_backend import JatsDocumentBackend
from sift_parse.backend.xml.uspto_backend import PatentUsptoDocumentBackend
from sift_parse.backend.xml.xbrl_backend import XBRLDocumentBackend
...
from sift_parse.datamodel.document import (
    ConversionResult,
    InputDocument,
...
from sift_parse.datamodel.pipeline_options import ConvertPipelineOptions, PipelineOptions
from sift_parse.datamodel.settings import (
    DEFAULT_PAGE_RANGE,
    DocumentLimits,
    PageRange,
    settings,
)
from sift_parse.exceptions import ConversionError
from sift_parse.pipeline.asr_pipeline import AsrPipeline
from sift_parse.pipeline.base_pipeline import BasePipeline
from sift_parse.pipeline.simple_pipeline import SimplePipeline
...
from sift_parse.utils.utils import chunkify
...
class DocumentConverter:
    ...
    def __init__(
        ...
        Examples:
            ...
            >>> from sift_parse.datamodel.base_models import InputFormat
            >>> converter = DocumentConverter(
    ...
    def initialize_pipeline(self, format: InputFormat):
        ...
        Raises:
            ...
            RuntimeError: If `artifacts_path` is set in
                `sift_parse.datamodel.settings.settings` when required by
    ...
    def convert(
        ...
        Examples:
            ...
            >>> from io import BytesIO
            >>> from sift_parse.datamodel.base_models import DocumentStream
