...
(:mod:`sift_parse.backend.msword_backend`, :mod:`sift_parse.backend.mspowerpoint_backend`,
:mod:`sift_parse.backend.msexcel_backend`).
...
from sift_parse.datamodel.backend_options import OdsBackendOptions
...
_INSTALL_HINT = (
    ...
    "Install it with `pip install 'sift-parse[format-opendocument]'`."
)
