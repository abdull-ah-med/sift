...
Warning:
    ...
    change in a new release of the `sift-parse-core` library. This implementation
...
from sift_parse.datamodel.backend_options import HTMLBackendOptions, XBRLBackendOptions
from sift_parse.datamodel.base_models import InputFormat
from sift_parse.datamodel.document import InputDocument
from sift_parse.exceptions import DocumentLoadError, OperationNotAllowed
    ...
    def __init__(
        ...
        if not _XBRL_AVAILABLE:
            raise ImportError(
                ...
                "Please install it using `pip install 'sift-parse[format-xml-xbrl]'`"
