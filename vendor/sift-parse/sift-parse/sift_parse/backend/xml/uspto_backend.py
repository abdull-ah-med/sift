...
from sift_parse_core.types.doc.document import LevelNumber
...
_INSTALL_HINT = (
    ...
    "Install them with `pip install 'sift-parse[format-xml-uspto]'`."
)
...
class PatentHeading(Enum):
    """Text of sift_parse headings for tagged sections in USPTO patent documents."""
...
class PatentUspto(ABC):
    ...
    def parse(self, patent_content: str) -> DoclingDocument | None:
        ...
        Returns:
            The patent parsed as a sift_parse document.
        """
...
class PatentUsptoIce(PatentUspto):
    ...
    class PatentHandler(ContentHandler):
        ...
        def __init__(self) -> None:
            ...
            # Keep track of sift_parse hierarchy level
            self.level: LevelNumber = 1
            # Keep track of sift_parse parents by level
...
class PatentUsptoGrantAps(PatentUspto):
    ...
    def store_section(self, section: str) -> None:
        """Store the section heading in the sift_parse document.
    ...
    def store_content(self, section: str, field: str, value: str) -> None:
        """Store the key value within a document section in the sift_parse document.
