...
from sift_parse_core.types.doc import DocItemLabel, DoclingDocument, DocumentOrigin
...
from sift_parse.datamodel.backend_options import EmailBackendOptions, HTMLBackendOptions
...
# would therefore break `import sift_parse` on installs that omit the extra (the
...
_INSTALL_HINT = (
    ...
    "Install it with `pip install 'sift-parse[format-email]'`."
)
