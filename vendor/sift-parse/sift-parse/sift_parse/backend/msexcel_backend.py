...
from sift_parse.datamodel.backend_options import MsExcelBackendOptions
...
_INSTALL_HINT = (
    ...
    "Install it with `pip install 'sift-parse[format-xlsx]'`."
)
...
# "barChart") to the sift_parse picture-classification label we tag the emitted
