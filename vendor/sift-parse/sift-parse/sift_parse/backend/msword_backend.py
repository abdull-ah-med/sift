...
from sift_parse_core.types.doc.document import FineRef, Formatting, Script
...
from sift_parse.backend.docx.drawingml.utils import (
    convert_to_modern_format,
    get_docx_to_pdf_converter,
    get_pil_from_dml_docx,
)
from sift_parse.backend.docx.latex.omml import oMath2Latex
from sift_parse.datamodel.backend_options import MsWordBackendOptions
from sift_parse.datamodel.base_models import FormatToMimeType
from sift_parse.datamodel.document import InputDocument, InputFormat
from sift_parse.exceptions import DocumentLoadError, SecurityError
from sift_parse.utils.code_language import CodeLanguageLabel, detect_code_language
...
_INSTALL_HINT = (
    ...
    "Install it with `pip install 'sift-parse[format-docx]'`."
)
...
"""Maps a DrawingML chart plot element name to a sift_parse picture-classification label.
...
class MsWordDocumentBackend(DeclarativeDocumentBackend):
    ...
    def _classify_chart(self, chart_root: Any) -> PictureClassificationLabel:
        ...
        mapped to a sift_parse classification label; unknown or combination charts
