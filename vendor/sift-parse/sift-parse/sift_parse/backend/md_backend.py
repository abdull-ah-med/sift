...
from sift_parse.utils.code_language import detect_code_language
...
# break `import sift_parse` on installs that omit the extra (the slim packages in
...
_INSTALL_HINT = (
    ...
    "Install it with `pip install 'sift-parse[format-markdown]'`."
)
