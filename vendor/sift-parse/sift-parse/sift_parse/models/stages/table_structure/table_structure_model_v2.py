...
from sift_parse_core.types.doc import BoundingBox, DocItemLabel, TableCell
...
from sift_parse.datamodel.base_models import Cluster, Page, Table, TableStructurePrediction
from sift_parse.datamodel.document import ConversionResult
from sift_parse.datamodel.pipeline_options import TableStructureV2Options
from sift_parse.datamodel.settings import settings
from sift_parse.models.base_table_model import BaseTableStructureModel
...
class TableStructureModelV2(BaseTableStructureModel):
    ...
    def __init__(
        ...
        if self.enabled:
            ...
            from sift_parse_models.tableformer_v2 import TableFormerV2
