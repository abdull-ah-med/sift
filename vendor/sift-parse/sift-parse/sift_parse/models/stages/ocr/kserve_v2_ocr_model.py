...
from sift_parse.datamodel.kserve_transport_utils import resolve_kserve_transport_base_url
from sift_parse.datamodel.pipeline_options import KserveV2OcrOptions, OcrOptions
from sift_parse.datamodel.settings import settings
from sift_parse.models.base_ocr_model import BaseOcrModel
from sift_parse.models.inference_engines.common import KserveV2Client, KserveV2HttpClient
...
class KserveV2OcrModel(BaseOcrModel):
    ...
    def _initialize_client(self) -> None:
        ...
        if self.options.transport == "http":
            ...
            from sift_parse.models.inference_engines.common.kserve_v2_grpc import (
                KserveV2GrpcClient,
            )
