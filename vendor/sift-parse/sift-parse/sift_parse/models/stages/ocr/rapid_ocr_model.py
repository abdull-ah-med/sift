...
import numpy
from sift_parse_core.types.doc import BoundingBox, CoordOrigin
from sift_parse_core.types.doc.page import BoundingRectangle, TextCell

from sift_parse.datamodel.accelerator_options import AcceleratorDevice, AcceleratorOptions
from sift_parse.datamodel.base_models import Page
...
from sift_parse.utils.accelerator_utils import decide_device
from sift_parse.utils.profiling import TimeRecorder
from sift_parse.utils.utils import download_url_with_progress
...
# Inference backends sift_parse supports. Must stay in sync with the `backend` Literal of
# RapidOcrOptions in sift_parse/datamodel/pipeline_options.py and with the mapping built in
...
def _backend_to_engine_type(backend: str) -> "EngineType":
    """Map a sift_parse backend name onto the rapidocr EngineType it stands for."""
            ...
            if artifacts_path is not None:
                ...
                if missing:
                    ...
                    raise FileNotFoundError(
                        ...
                        f"Missing files:\n{listed}\n"
                        "Prefetch them with:\n"
                        f"  sift-parse-tools models download rapidocr "
