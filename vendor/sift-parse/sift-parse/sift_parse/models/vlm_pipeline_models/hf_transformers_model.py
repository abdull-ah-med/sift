...
from sift_parse.datamodel.accelerator_options import (
    AcceleratorOptions,
)
from sift_parse.datamodel.base_models import Page, VlmPrediction, VlmStopReason
...
from sift_parse.models.utils.generation_utils import GenerationStopper
from sift_parse.models.utils.hf_model_download import (
    HuggingFaceModelDownloadMixin,
)
from sift_parse.models.utils.hf_stopping_criteria import HFStoppingCriteriaWrapper
...
class HuggingFaceTransformersVlmModel(BaseVlmPageModel, HuggingFaceModelDownloadMixin):
        ...
        if self.enabled:
            ...
            if artifacts_path is None:
                ...
                raise FileNotFoundError(
                    ...
                    f"To fix this issue:\n"
                    f"  1. Download the model: sift-parse-tools models download-hf-repo {self.vlm_options.repo_id}\n"
    ...
    def process_images(
        ...
        if (
            ...
            from sift_parse.utils.vlm_utils import strip_stop_strings
