...
from sift_parse.models.inference_engines.vlm.factory import create_vlm_engine

# Engine implementations are NOT imported here to avoid circular imports
# They can be imported directly when needed:
#   from sift_parse.models.inference_engines.vlm.transformers_engine import TransformersVlmEngine
