...
from sift_parse.models.inference_engines.vlm.base import (
    BaseVlmEngine,
...
if TYPE_CHECKING:
    from sift_parse.datamodel.stage_model_specs import EngineModelConfig, VlmModelSpec
    from sift_parse.datamodel.vlm_engine_options import (
        ApiVlmEngineOptions,
...
def create_vlm_engine(
    *,
    ...
    if engine_type == VlmEngineType.AUTO_INLINE:
        from sift_parse.datamodel.vlm_engine_options import AutoInlineVlmEngineOptions
        from sift_parse.models.inference_engines.vlm.auto_inline_engine import (
            AutoInlineVlmEngine,
        )
        ...
        from sift_parse.datamodel.vlm_engine_options import TransformersVlmEngineOptions
        from sift_parse.models.inference_engines.vlm.transformers_engine import (
        ...
        from sift_parse.datamodel.vlm_engine_options import MlxVlmEngineOptions
        from sift_parse.models.inference_engines.vlm.mlx_engine import MlxVlmEngine
        ...
        from sift_parse.datamodel.vlm_engine_options import VllmVlmEngineOptions
        from sift_parse.models.inference_engines.vlm.vllm_engine import VllmVlmEngine
        ...
        from sift_parse.datamodel.vlm_engine_options import ApiVlmEngineOptions
        from sift_parse.models.inference_engines.vlm.api_openai_compatible_engine import (
            ApiVlmEngine,
        )
