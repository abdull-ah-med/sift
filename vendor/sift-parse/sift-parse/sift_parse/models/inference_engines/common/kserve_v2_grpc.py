...
from sift_parse.models.inference_engines.common.kserve_v2_types import (
    KSERVE_V2_NUMPY_DATATYPES,
    NUMPY_KSERVE_V2_DATATYPES,
    KserveV2ModelMetadataResponse,
    KserveV2ModelTensorSpec,
)
from sift_parse.models.inference_engines.common.kserve_v2_utils import (
    decode_bytes_tensor,
    ...
    def __post_init__(self) -> None:
        if grpc is None or service_pb2 is None or service_pb2_grpc is None:
            raise ImportError(
                ...
                "Install with: pip install 'sift_parse[remote-serving]'"
            )
