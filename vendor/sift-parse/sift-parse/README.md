...
[![Docs](https://img.shields.io/badge/docs-live-brightgreen)](https://docling-project.github.io/sift_parse/)
[![PyPI version](https://img.shields.io/pypi/v/sift_parse)](https://pypi.org/project/sift_parse/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/sift_parse)](https://pypi.org/project/sift_parse/)
...
[![PyPI Downloads](https://static.pepy.tech/badge/sift_parse/month)](https://pepy.tech/projects/sift_parse)
[![Docling Actor](https://apify.com/actor-badge?actor=vancura/sift_parse&fpr=sift_parse)](https://apify.com/vancura/sift_parse)
...
[![Discord](https://img.shields.io/discord/1399788921306746971?color=6A7EC2&logo=discord&logoColor=ffffff)](https://sift_parse.ai/discord)
...
- 🔌 Connect to any agent using the [MCP server](https://docling-project.github.io/sift_parse/usage/mcp/)
- 🌐 Run Docling as a service with the [API server](https://docling-project.github.io/sift_parse/usage/api_server/) (docling-serve)
...
```bash
pip install sift_parse
```

> **Note:** Python 3.9 support was dropped in sift_parse version 2.70.0. Please use Python 3.10 or higher.

Works on macOS, Linux and Windows environments for both x86_64 and arm64 architectures.

More [detailed installation instructions](https://docling-project.github.io/sift_parse/getting_started/installation/) are available in the docs.

## 2. Convert a document (CLI)

```bash
sift_parse https://arxiv.org/pdf/2206.01062
```
...
```bash
sift_parse --pipeline vlm --vlm-model granite_docling https://arxiv.org/pdf/2206.01062
```
...
More advanced [usage](https://docling-project.github.io/sift_parse/usage/) and [configuration](https://docling-project.github.io/sift_parse/getting_started/installation/) options.

## Documentation

Check out Docling's [documentation](https://docling-project.github.io/sift_parse/) for details on
installation, usage, concepts, recipes, extensions, and more.

## Examples

Go hands-on with our [examples](https://docling-project.github.io/sift_parse/examples/),
demonstrating how to address different application use cases with Docling.

## Integrations

To further accelerate your AI application development, check out Docling's native
[integrations](https://docling-project.github.io/sift_parse/integrations/) with popular frameworks
and tools.
...
[supported_formats]: https://docling-project.github.io/sift_parse/usage/supported_formats/
[docling_document]: https://docling-project.github.io/sift_parse/concepts/docling_document/
[integrations]: https://docling-project.github.io/sift_parse/integrations/
[extraction]: https://docling-project.github.io/sift_parse/_generated/examples/extraction/
