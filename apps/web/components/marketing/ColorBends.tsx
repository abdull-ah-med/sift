...
/** React Bits ColorBends. Upstream: MIT + Commons Clause. Needs `three`. */
...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    // Mount-only. Uniforms sync in the effect below.
    // eslint-disable-next-line react-hooks/exhaustive-deps -- WebGL context is created once
  }, []);
