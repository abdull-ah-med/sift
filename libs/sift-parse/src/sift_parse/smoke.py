"""Phase 0 parse smoke: digital PDF extraction with optional Docling path."""
...
def _docling_converter() -> SupportsConvert:
    try:
...
def run_parse_smoke(
    ...
    *,
    ...
    downloading layout models). Set ``SIFT_PARSE_ENGINE=docling`` (or pass
    ...
    if engine in {"docling", "sift-parse", "standard"}:
